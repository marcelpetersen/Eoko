...
//$scope.blurry = $scope.popover.isShown() ? $scope.blurry = {behind : "5px"} : $scope.blurry = {behind : "0px"};
  ...
  .controller('buildingEventsCtrl', ['$scope', '$stateParams', 'UserInfo','$firebaseObject','$firebaseArray','$ionicPopup','$ionicPopover','$ionicSlideBoxDelegate', // The following is the constructor function for this page's controller. See https://docs.angularjs.org/guide/controller
...
// TIP: Access Route Parameters for your page via $stateParams.parameterName
  ...
  .controller('notificationPageCtrl', ['$scope', '$stateParams', 'UserInfo', '$firebaseObject', '$timeout', '$ionicScrollDelegate','$ionicPopover', // The following is the constructor function for this page's controller. See https://docs.angularjs.org/guide/controller
// You can include any angular dependencies as parameters for this function
// TIP: Access Route Parameters for your page via $stateParams.parameterName
    function ($scope, $stateParams, UserInfo, $firebaseObject, $timeout, $ionicScrollDelegate,$ionicPopover) {
